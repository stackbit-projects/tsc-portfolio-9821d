...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5ff9821d6600bc0015d0bad9
...
To start editing your site, you can use the Sanity interface at https://tsc-portfolio-9821d.sanity.studio/.
...
Generated at `2021-01-09T10:16:19.463Z` by Stackbit version `0.3.42`.